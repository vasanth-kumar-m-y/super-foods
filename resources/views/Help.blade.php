...
<section align="center" id="helpcenterindesktopmode">
    ...
    <div class="card mb-4">
        <div class="view overlay">
            <img class="card-img-top" src="{{asset('Img/faq.jpg')}}" alt="Card image cap">
    ...
    <div class="card mb-4">
        <div class="view overlay">
           <img class="card-img-top" src="{{asset('Img/recieps.jpg')}}" alt="Card image cap">
           <a href="recieps">
                <!-- <div class="mask rgba-white-slight"></div> -->
            </a>
        </div>
        <div class="card-body">
            <h4 align="center" class="card-title font-weight-bold">Recipes</h4>  
            <a href="recieps" align="center" type="button" class="btaobtn btaobtn-outline-primary  btn-md  animated pulse infinite slow">Read more</a>
        </div>
    </div>
    ...
    <div class="card mb-4">
        <div class="view overlay">
            <img class="card-img-top" src="{{asset('Img/shipping-returns.jpg')}}" alt="Card image cap">
    ...
    <div class="card mb-4">
        <div class="view overlay">
            <img class="card-img-top" src="{{asset('Img/contact-us.jpg')}}" alt="Card image cap">
            <a href="Contact">
                <!-- <div class="mask rgba-white-slight"></div> -->
            </a>
        </div>
...
<section id="helpcenterinmobilemode" align="center"  class="wow fadeInUp" id="featuredproducts">
    ...
    <div class="card mb-2">
    <img class="card-img-top animated pulse infinite slow" src="{{asset('Img/faq.jpg')}}" alt="Card image cap">
    <div class="card-body">
    ...
    <div class="col-12 col-md-3">
    <div class="card mb-2">
    <img class="card-img-top animated pulse infinite slow" src="{{asset('Img/recieps.jpg')}}" alt="Card image cap">
    <div class="card-body">
    <h4 class="card-title font-weight-bold">Recipes</h4>
    ...
    <div class="col-12 col-md-3">
    <div class="card mb-2">
    <img class="card-img-top animated pulse infinite slow" src="{{asset('Img/shipping-returns.jpg')}}" alt="Card image cap">
    <div class="card-body">
    ...
    <div class="col-12 col-md-3">
    <div class="card mb-2">
    <img class="card-img-top animated pulse infinite slow" src="{{asset('Img/contact-us.jpg')}}" alt="Card image cap">
    <div class="card-body">
