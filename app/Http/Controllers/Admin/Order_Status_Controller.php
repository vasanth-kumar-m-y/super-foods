...
class Order_Status_Controller extends Controller
{
    public function Order_Status(Request $request, $id)
    {
     ...
     public function Update_Shipping_Status(Request $request)
     {
        ...
        $emailbody='<p>Your Order has been Shipped. Your estimated delivery date is 3-5 working days. If you would like to view the status of your order or make any changes to it, please visit Your Orders on <a href="'.$url.'">Superfoods.in</a></p><br>
        ...
        ($loginid, $name,$id)
        {
            ...
            (' Your Superfoods.in order '.$id.' is Shipped');
            $message->from('vasanthaws28@gmail.com','SuperFoods');
     ...
     public function Update_Delivery_Status(Request $request)
     {
        ...
        {
            $message->to($loginid, $name)->subject
            ('Your Superfoods.in order '.$id.' is Delivered');
            $message->from('vasanthaws28@gmail.com','SuperFoods');
    ...
    public function Update_paymentmode_Status(Request $request)
    {
     ...
     { 
        ...
        {
          $message->to($loginid, $name)->subject
          ('Your Superfoods.in order '.$id.' is Cancelled');
          $message->from('vasanthaws28@gmail.com','SuperFoods');
        });
