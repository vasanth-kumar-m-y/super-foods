        ...
        public function  order_proceed(Request $request)
        {
            ...
            /*Order Details Ends Here*/
                ...
                if($p_method=='Online')
                {
                    ...
                    <p>Thank you for your order. We’ll send a confirmation when your order ships. Your estimated delivery date is 3-5 working days. If you would like to view the status of your order or make any changes to it, please visit Your Orders on <a href="'.$url.'">Superfoods.in</a></p>
                    ...
                    ($loginid, $name,$id)
                    {
                        ...
                        ('Your Superfoods.in order '.$id.' is Confirmed');
